...
//   return (
//     <div>
//       <h1 className="font-semibold text-3xl my-5">List of Items</h1>

//       {/* Button to navigate to Admin page */}
//       <button
//         onClick={() => navigate('/admin')}
//         className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 mb-5 mr-4 rounded-lg shadow-md hover:from-blue-600 hover:to-blue-700 transition-all duration-300"
//       >
//         Only for Admin
//       </button>

//       {/* Category Drawer Button and Price Sorting Button */}
//       <div className="mb-5 relative flex gap-4">
//         {/* Category Drawer Button */}
//         <button
//           onClick={() => setIsDrawerOpen(!isDrawerOpen)}
//           className="bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-3 rounded-lg shadow-md hover:from-green-600 hover:to-green-700 transition-all duration-300"
//         >
//           Categories
//         </button>
...
//           className="bg-gradient-to-r from-purple-500 to-purple-600 text-white px-6 py-3 rounded-lg shadow-md hover:from-purple-600 hover:to-purple-700 transition-all duration-300"
//         >
...
//         {isDrawerOpen && (
//           <div className="absolute bg-white shadow-lg mt-2 p-4 rounded-lg z-10 w-48">
//             <button
